...
const HeaderBar = styled.header<{ isDropDownOpened: boolean; theme: any }>`
    ...
    background-color: ${ props => props.isDropDownOpened ? 'white' : props.theme.main};
    height: 2.7rem;
    padding: 1rem;
`;
...
const Navigation = styled.ul<{ opened: boolean}>`
    list-style: none;
    display: flex;
    margin: 0;
...
const Logo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="146" height="40" viewBox="0 0 146 56">
...
export default class Header extends React.Component<IHeaderProps, IHeaderState> {
    ...
    public renderActionBar() {
        return (
            <>
                <ActionBar>
                    <Navigation opened={this.state.isDropdownOpened}>
                        <NavigationLink>JOGS</NavigationLink>
                        <NavigationLink>INFO</NavigationLink>
                        <NavigationLink>CONTACT US</NavigationLink>
                    </Navigation>
                    <FilterIcon />
                    <StyledHamburger onClick={this.openDropdown} height="32px" viewBox="0 0 32 32" width="32px">
