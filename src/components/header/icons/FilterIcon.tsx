...
const StyledFilterIcon = styled.svg<IFilterIconProps>`
    display: block;
    cursor: pointer;
...
const FilterIcon = (props: IFilterIconProps) => (
    <StyledFilterIcon isActive={props.isActive} onClick={props.onClick} hide={props.hide} width="29" height="29" viewBox="0 0 39 39">
        <g fill="none" fill-rule="evenodd">
            ...
            <rect width="37" height="37" x="1" y="1" stroke={props.isActive ? 'white' : '#62AA14'} stroke-width="2" rx="6"/>
        </g>
    </StyledFilterIcon>
);
